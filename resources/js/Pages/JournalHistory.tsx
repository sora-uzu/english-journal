                        ...
                        <div className="space-y-4 sm:space-y-6">
                            <div className="mx-auto w-full max-w-md">
                                <div className="flex flex-col gap-2.5 sm:flex-row sm:items-center sm:justify-between sm:gap-3">
                                    ...
                                    <div className="flex items-center gap-2.5 sm:gap-3">
                                        <Link
                                            ...
                                            className="rounded-full border border-white/60 bg-white/40 px-3 py-1 text-sm text-slate-700 backdrop-blur hover:border-white/80 hover:text-slate-900"
                                        >
                                            ← Prev
                                        </Link>
                                        <Link
                                ...
                                <div className="mt-4 sm:mt-6">
                                    <div className="grid grid-cols-7 text-center text-xs font-medium uppercase tracking-wide text-slate-400">
                                    ...
                                    <div className="grid grid-cols-7 gap-y-2.5 sm:gap-y-3 text-sm">
                                        {cells.map((day, idx) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div
                                                        className={`${baseDayClass} cursor-default text-slate-400`}
                                                    >
                                                        {day}
                                                    </div>
                                                </div>
                            ...
                            <div>
                                ...
                                {keyPhrases.length === 0 ? (
                                    !hasAnyEntries ? (
                                        <div className="mt-4 rounded-2xl border border-white/60 bg-white/30 p-4 backdrop-blur">
                                        ...
                                        <div className="mt-3 sm:mt-4 text-sm text-slate-600">
                                            <p>
                                                今月はまだキーフレーズがありません。
                                            </p>
                                        ...
                                        <div className="mt-3 sm:mt-4 space-y-3">
                                            {firstPhrase && (
                                                <Link
                                                    ...
                                                    className="flex gap-3 rounded-2xl border border-white/50 bg-white/30 px-3 py-2 backdrop-blur transition hover:border-white/80 hover:bg-white/40"
                                                >
